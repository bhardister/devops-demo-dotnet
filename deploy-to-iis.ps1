...
octo create-release --project devops-demo-dotnet --version $v --package "devops-demo-dotnet:$v" --deployto dev --server https://octotest.sslocal.com -apiKey $octoTestApiKey
